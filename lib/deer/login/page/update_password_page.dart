...
class UpdatePasswordPage extends StatefulWidget {
  ...
  @override
  State<StatefulWidget> createState() => _UpdatePasswordPageState();
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: MyScrollView(
        ...
        children: <Widget>[
          const Text('重置登录密码', style: TextStyles.textBold26,),
          Gaps.vGap8,
          Text('设置账号 15000000000', style: Theme.of(context).textTheme.subtitle2.copyWith(fontSize: Dimens.font_sp12),),
          Gaps.vGap32,
          MyTextField(
